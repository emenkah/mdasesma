...
!and the dot product with the axis is =+ve and at the next instance it is negative then an  inversion has occured
    ...
    out_file = in_file(29:33)
	TD = in_file(21:21)
    call system('mkdir -p output/eiginv')
    out_file1 = 'output/eiginv/'//'Eigen-'//TD//'ZVP'//trim(out_file)//'dat'
    ...
    out_file2 = 'output/eiginv/'//'Eigen_vmdcheck_'//TD//'ZVP'//trim(out_file)//'txt'
    ...
    out_file = in_file(29:32)
    out_file1 = 'output/eiginv/'//'Eigen-'//TD//'ZVP'//trim(out_file)//'-tim.dat'
